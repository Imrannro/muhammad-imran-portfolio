    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <a
          href="#"
          id="nav-brand-logo"
          aria-label="Muhammad Imran - DevOps Engineer & Full-Stack Developer Portfolio Home"
        ...
        <div className="hidden sm:flex items-center gap-3">
          ...
          <button
            ...
            aria-label="Open CI/CD Pipeline Simulator interactive CLI terminal"
            className="flex items-center gap-1.5 px-3.5 py-2.5 min-h-[44px] rounded-xl text-xs font-mono text-[#6b6b6b] dark:text-[#8e8e8e] light:text-slate-700 hover:text-[#22d472] dark:hover:text-[#22d472] light:hover:text-[#16a34a] bg-[#121212] dark:bg-[#121212] light:bg-slate-100 border border-[#212121] dark:border-[#212121] light:border-slate-200 hover:border-[#22d472]/40 dark:hover:border-[#22d472]/40 light:hover:border-[#16a34a]/40 transition-all cursor-pointer font-semibold"
          ...
          <button
            ...
            aria-label="Open full CV and Resume viewer"
            className="flex items-center gap-1.5 px-4 py-2.5 min-h-[44px] rounded-xl text-xs font-mono text-[#f2f2f2] dark:text-[#f2f2f2] light:text-slate-800 bg-[#121212] dark:bg-[#121212] light:bg-slate-100 border border-[#212121] dark:border-[#212121] light:border-slate-200 hover:border-[#22d472] dark:hover:border-[#22d472] light:hover:border-[#16a34a] hover:text-[#22d472] dark:hover:text-[#22d472] light:hover:text-[#16a34a] transition-all cursor-pointer font-semibold"
          >
          ...
          <a
            id="nav-hire-btn"
            href="#contact"
            aria-label="Contact Muhammad Imran for hire or project inquiries"
            className="flex items-center gap-1 px-4 py-2.5 min-h-[44px] rounded-xl text-xs sm:text-sm font-semibold bg-[#22d472] dark:bg-[#22d472] light:bg-[#16a34a] text-[#0a0a0a] light:text-white hover:bg-[#18a355] transition-all shadow-[0_0_16px_rgba(34,212,114,0.25)] hover:shadow-[0_0_24px_rgba(34,212,114,0.4)]"
          >
            <span>Hire me</span>
        ...
        <div className="flex sm:hidden items-center gap-1.5">
          ...
          <button
            onClick={toggleTheme}
            className="flex items-center justify-center w-11 h-11 min-w-[44px] min-h-[44px] text-[#6b6b6b] dark:text-[#6b6b6b] light:text-slate-700 bg-[#121212] dark:bg-[#121212] light:bg-slate-100 border border-[#212121] dark:border-[#212121] light:border-slate-200 rounded-xl cursor-pointer"
            aria-label={`Switch to ${theme === 'dark' ? 'light' : 'dark'} mode`}
          >
          ...
          <button
            ...
            onClick={onOpenTerminal}
            className="flex items-center justify-center w-11 h-11 min-w-[44px] min-h-[44px] text-[#22d472] dark:text-[#22d472] light:text-[#16a34a] bg-[#121212] dark:bg-[#121212] light:bg-slate-100 border border-[#212121] dark:border-[#212121] light:border-slate-200 rounded-xl cursor-pointer"
            aria-label="Open CI/CD Pipeline Simulator interactive terminal"
          >
          ...
          <button
            ...
            className="flex items-center justify-center w-11 h-11 min-w-[44px] min-h-[44px] text-[#f2f2f2] dark:text-[#f2f2f2] light:text-slate-800 hover:text-[#22d472] dark:hover:text-[#22d472] light:hover:text-[#16a34a] bg-[#121212] dark:bg-[#121212] light:bg-slate-100 border border-[#212121] dark:border-[#212121] light:border-slate-200 rounded-xl transition-colors cursor-pointer"
